...
for e in epochs:  # loop over epochs
    ...
    for batch in train_loader:  # Use DataLoader for batching
        ...
        # x_t_pred = sqrt_alpha_bar_t * x0 + sqrt_one_minus_alpha_bar_t * predicted_noise.squeeze()  # Reshape predicted_noise to match x_t
        # Reshape x_t_pred to match x_t
        # loss = torch.nn.MSELoss()(x_t,x_t_pred) 
