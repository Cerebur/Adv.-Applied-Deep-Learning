...
# Prepare data
train_loader, val_loader, test_loader, spectra_length, n_labels, labelNames, ranges = prepare_data(DATA_PATH, train_fraction, val_fraction, batch_size)
